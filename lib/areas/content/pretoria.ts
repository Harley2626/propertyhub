...
export const pretoriaArea: AreaGuide = {
  ...
  averagePrices: [
    {
      label: "Entry-level apartment (central / west)",
      range: "R550,000 – R1 million",
    },
    {
      label: "Mid-market family home (Montana, Garsfontein)",
      range: "R1.3 million – R2.5 million",
    },
    {
      label: "Centurion apartment / townhouse",
      range: "R900,000 – R2.2 million",
    },
    {
      label: "Premium home (Waterkloof, Brooklyn)",
      range: "R3 million – R10 million+",
    },
  ],
  popularSuburbs: [
    {
