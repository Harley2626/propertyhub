...
export const transferDutyGuide2025: GuideArticle = {
  slug: "transfer-duty-calculator-south-africa-2025",
  title: "Transfer Duty Calculator South Africa (2025 Guide)",
  description:
  ...
  keywords: [
    ...
    "sars transfer duty 2025",
    "transfer duty brackets",
  ...
  sections: [
    ...
    {
      id: "brackets-2025",
      title: "2025 transfer duty brackets explained",
      paragraphs: [
    ...
    {
      id: "how-calculated",
      title: "How transfer duty is calculated",
      paragraphs: [
    ...
    {
      id: "vat-vs-duty",
      title: "Transfer duty vs VAT on property",
      paragraphs: [
    ...
    {
      id: "exemptions",
      title: "Transfer duty exemptions and special cases",
      paragraphs: [
    ...
    {
      id: "budgeting",
      title: "Budgeting for transfer duty alongside other costs",
      paragraphs: [
    ...
    {
      id: "using-calculator",
      title: "How to use a transfer duty calculator",
      paragraphs: [
    ...
    {
      id: "practical-tips",
      title: "Practical tips for property buyers",
      paragraphs: [
    ...
    {
      id: "market-context",
      title: "Transfer duty in the South African property market",
      paragraphs: [
  ...
  faqs: [
    {
      question: "What are the transfer duty rates for 2025?",
      answer:
    ...
    {
      question: "How much transfer duty on a R2 million house?",
      answer:
    ...
    {
      question: "Is transfer duty the same as conveyancing fees?",
      answer:
    ...
    {
      question: "Can I add transfer duty to my home loan?",
      answer:
    ...
    {
      question: "When is VAT charged instead of transfer duty?",
      answer:
    ...
    {
      question: "Who calculates and pays transfer duty to SARS?",
      answer:
    ...
    {
      question: "Does transfer duty apply to vacant land?",
      answer:
    ...
    {
      question: "Are transfer duty brackets updated every year?",
      answer:
