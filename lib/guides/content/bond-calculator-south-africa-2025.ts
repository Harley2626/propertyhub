...
export const bondCalculatorGuide2025: GuideArticle = {
  ...
  keywords: [
    ...
    "bond affordability south africa",
    "bond approval process",
    "property deposit south africa",
    "propertypilot",
  ],
  sections: [
    {
    ...
    {
      id: "affordability",
      title: "Affordability: what banks look for",
      paragraphs: [
    ...
    {
      id: "bond-approval",
      title: "How bond approval works in South Africa",
      paragraphs: [
  ...
  faqs: [
    ...
    {
      question: "How do banks assess bond affordability in South Africa?",
      answer:
    ...
    {
      question: "How long does bond approval take?",
      answer:
