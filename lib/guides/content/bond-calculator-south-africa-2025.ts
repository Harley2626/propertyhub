...
export const bondCalculatorGuide2025: GuideArticle = {
  slug: "bond-calculator-south-africa-2025",
  title: "Bond Calculator South Africa (2025 Guide)",
  description:
    "Learn how South African home loan repayments work — interest rates, deposits, loan terms, and how to use a bond calculator to estimate your monthly instalment.",
  tag: "Property",
  ...
  sections: [
    {
      id: "introduction",
      title: "What is a bond in South Africa?",
      paragraphs: [
        ...
        "This guide explains how bond repayments are calculated, how interest rates affect your costs, why deposits matter, and how to choose a loan term. Whether you are a first-time buyer in Johannesburg, upgrading in Cape Town, or investing in Durban, the same principles apply across South African banks including Absa, FNB, Nedbank, Standard Bank, and Capitec.",
      ],
    },
    {
      id: "how-repayments-work",
      title: "How bond repayments work",
      paragraphs: [
    ...
    {
      id: "interest-rates",
      title: "Understanding interest rates on home loans",
      paragraphs: [
    ...
    {
      id: "deposits",
      title: "Deposits and loan-to-value",
      paragraphs: [
    ...
    {
      id: "repayment-periods",
      title: "Choosing a repayment period",
      paragraphs: [
    ...
    {
      id: "using-a-bond-calculator",
      title: "How to use a bond calculator",
      paragraphs: [
    ...
    {
      id: "beyond-the-instalment",
      title: "Costs beyond the monthly instalment",
      paragraphs: [
    ...
    {
      id: "practical-tips",
      title: "Practical tips for South African homebuyers",
      paragraphs: [
  ...
  faqs: [
    {
      question: "How accurate is a bond calculator?",
      answer:
    ...
    {
      question: "What interest rate should I use in a bond calculator?",
      answer:
    ...
    {
      question: "Can I get a 100% bond in South Africa?",
      answer:
    ...
    {
      question: "What is the difference between prime and the repo rate?",
      answer:
    ...
    {
      question: "Is a 20-year or 30-year bond better?",
      answer:
    ...
    {
      question: "Does the bond calculator include transfer duty and legal fees?",
      answer:
    ...
    {
      question: "What happens if interest rates go up after I take a bond?",
      answer:
    ...
    {
      question: "Can I pay extra into my bond?",
      answer:
